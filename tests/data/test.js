...
$root.jspb = (function() {
    ...
    jspb.test = (function() {
        ...
        test.Simple1 = (function() {
             ...
             * @property {aaaa.b.ISomething|null} [aSomething] Simple1 aSomething
             */
            ...
            /**
             * Simple1 aSomething.
             * @member {aaaa.b.ISomething|null|undefined} aSomething
             * @memberof jspb.test.Simple1
             * @instance
             */
            Simple1.prototype.aSomething = null;
            ...
            Simple1.encode = function encode(message, writer) {
                ...
                if (message.aSomething != null && Object.hasOwnProperty.call(message, "aSomething"))
                    $root.aaaa.b.Something.encode(message.aSomething, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
                return writer;
            };
            ...
            Simple1.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    case 4: {
                            message.aSomething = $root.aaaa.b.Something.decode(reader, reader.uint32());
                            break;
                        }
                    default:
                        reader.skipType(tag & 7);
            ...
            Simple1.verify = function verify(message) {
                ...
                if (message.aSomething != null && message.hasOwnProperty("aSomething")) {
                    var error = $root.aaaa.b.Something.verify(message.aSomething);
                    if (error)
            ...
            Simple1.fromObject = function fromObject(object) {
                ...
                if (object.aSomething != null) {
                    ...
                    message.aSomething = $root.aaaa.b.Something.fromObject(object.aSomething);
                }
                return message;
            };
            ...
            Simple1.toObject = function toObject(message, options) {
                ...
                if (message.aSomething != null && message.hasOwnProperty("aSomething"))
                    object.aSomething = $root.aaaa.b.Something.toObject(message.aSomething, options);
                return object;
            };
